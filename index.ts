...
let Basic_Currency:string = "";

let Currencies:string[] = [];
let Signs:string[] = [];
let ConversionToUSD:number[] = [];
let USDToUserChoice:number[] = [];
...
type task = {
    Basic_Currency_Name: string;
    Convert_Currency_Name: string;
    Basic_Currency_Index:number;
    Convert_Currency_Index:number
    Amount: number;
};
